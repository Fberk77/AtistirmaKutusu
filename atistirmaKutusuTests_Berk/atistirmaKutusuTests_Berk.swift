...
import XCTest
import Alamofire
@testable import atistirmaKutusu

final class atistirmaKutusuTests_Berk: XCTestCase {
    ...
    func testFetchUserAndCheck() async throws {
        ...
        do {
            let userResponse = try await manager.fetch(path: .users, methot: .get, type: UserResponse.self)
